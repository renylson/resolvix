...
class DashboardHandler(BaseHTTPRequestHandler):
    ...
    # Caminho para o arquivo dashboard
    ...
    def do_GET(self):
        ...
        # Rota de métricas Unbound em JSON
    ...
    def serve_dashboard(self):
        """Servir arquivo HTML do dashboard"""
        try:
    ...
    def serve_unbound_stats_json(self):
        ...
        try:
            ...
            # Agregação por thread para as chaves esperadas pelo frontend
            aggregations = {
    ...
    def format_prometheus(metrics):
        ...
        # Mapeamento: nome esperado -> prefixo das métricas do Unbound
        aggregations = {
        ...
        # Somar por thread (corrigido para split por '.')
